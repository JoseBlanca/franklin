...
def create_dbxref_adder(dbxref_db, relations, dbxref_tag='Dbxref'):
    ...
    def add_dbxref_to_feature(item):
        ...
        if feature['id'] in relations:
            ...
            dbxref = _add_dbxrefs_to_dbxref(feature['attributes'].get(dbxref_tag,
                                                                      ''),
                                            [dbxref])
            feature['attributes'][dbxref_tag] = dbxref
        return FEATURE, feature
