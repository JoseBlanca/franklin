...
:download:`ngs_backbone 1.3.2 <downloads/ngs_backbone-1.3.2.tar.gz>`. Relased on 28-04-2011.

Changes:
  * UniVec_Core is now included and used by default.
  * Standard 454 adaptors included and used by default.
  * Several bugs fixed.
