        ...
        for library_info in snv.lib_alleles:
            ...
            if len(new_alleles) != 0:
                ...
                if 'library' in library_info:
                    new_library['lilbrary'] = library_info['library']
...
## Filters old
#def create_high_variable_region_filter2(max_variability, window_length=None):
#    'It creates a filter that filters seq_vars from high variable regions'
...
#def create_close_to_seqvar_filter2(distance):
